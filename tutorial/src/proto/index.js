...
$root.types = (function() {
    ...
    types.MessageCreateProfile = (function() {
         ...
         * @property {Uint8Array|null} [address] MessageCreateProfile address
         * @property {string|null} [username] MessageCreateProfile username
         * @property {string|null} [bio] MessageCreateProfile bio
         * @property {Array.<string>|null} [expertiseTags] MessageCreateProfile expertiseTags
         */
         ...
         * @instance
         */
        MessageCreateProfile.prototype.address = $util.newBuffer([]);
         ...
         * @member {Array.<string>} expertiseTags
         * @memberof types.MessageCreateProfile
         * @instance
         */
        MessageCreateProfile.prototype.expertiseTags = $util.emptyArray;
        ...
        MessageCreateProfile.encode = function encode(message, writer) {
            ...
            if (message.expertiseTags != null && message.expertiseTags.length)
                for (var i = 0; i < message.expertiseTags.length; ++i)
                    writer.uint32(/* id 4, wireType 2 =*/34).string(message.expertiseTags[i]);
            return writer;
        };
        ...
        MessageCreateProfile.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 4: {
                        if (!(message.expertiseTags && message.expertiseTags.length))
                            message.expertiseTags = [];
                        message.expertiseTags.push(reader.string());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        MessageCreateProfile.verify = function verify(message) {
            ...
            if (message.expertiseTags != null && message.hasOwnProperty("expertiseTags")) {
                if (!Array.isArray(message.expertiseTags))
                    return "expertiseTags: array expected";
                for (var i = 0; i < message.expertiseTags.length; ++i)
                    if (!$util.isString(message.expertiseTags[i]))
                        return "expertiseTags: string[] expected";
            }
            return null;
        };
        ...
        MessageCreateProfile.fromObject = function fromObject(object) {
            ...
            if (object.expertiseTags) {
                if (!Array.isArray(object.expertiseTags))
                    throw TypeError(".types.MessageCreateProfile.expertiseTags: array expected");
                message.expertiseTags = [];
                for (var i = 0; i < object.expertiseTags.length; ++i)
                    message.expertiseTags[i] = String(object.expertiseTags[i]);
            }
            return message;
        };
        ...
        MessageCreateProfile.toObject = function toObject(message, options) {
            ...
            if (message.expertiseTags && message.expertiseTags.length) {
                object.expertiseTags = [];
                for (var j = 0; j < message.expertiseTags.length; ++j)
                    object.expertiseTags[j] = message.expertiseTags[j];
            }
            return object;
        };
    ...
    types.MessageUpdateProfile = (function() {
         ...
         * @property {Uint8Array|null} [address] MessageUpdateProfile address
         * @property {string|null} [bio] MessageUpdateProfile bio
         * @property {Array.<string>|null} [expertiseTags] MessageUpdateProfile expertiseTags
         */
         ...
         * @instance
         */
        MessageUpdateProfile.prototype.address = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageUpdateProfile.prototype.expertiseTags = $util.emptyArray;
        ...
        MessageUpdateProfile.encode = function encode(message, writer) {
            ...
            if (message.expertiseTags != null && message.expertiseTags.length)
                for (var i = 0; i < message.expertiseTags.length; ++i)
                    writer.uint32(/* id 3, wireType 2 =*/26).string(message.expertiseTags[i]);
            return writer;
        };
        ...
        MessageUpdateProfile.fromObject = function fromObject(object) {
            ...
            if (object.expertiseTags) {
                if (!Array.isArray(object.expertiseTags))
                    throw TypeError(".types.MessageUpdateProfile.expertiseTags: array expected");
                message.expertiseTags = [];
                for (var i = 0; i < object.expertiseTags.length; ++i)
                    message.expertiseTags[i] = String(object.expertiseTags[i]);
            }
    ...
    types.MessageCreateQuestion = (function() {

        /**
         * Properties of a MessageCreateQuestion.
         * @memberof types
         * @interface IMessageCreateQuestion
         * @property {Uint8Array|null} [authorAddress] MessageCreateQuestion authorAddress
         * @property {string|null} [title] MessageCreateQuestion title
         * @property {string|null} [contentHash] MessageCreateQuestion contentHash
         * @property {string|null} [category] MessageCreateQuestion category
         * @property {Array.<string>|null} [tags] MessageCreateQuestion tags
         */

        /**
         * Constructs a new MessageCreateQuestion.
         * @memberof types
         * @classdesc Represents a MessageCreateQuestion.
         * @implements IMessageCreateQuestion
         * @constructor
         * @param {types.IMessageCreateQuestion=} [properties] Properties to set
         */
        function MessageCreateQuestion(properties) {
            this.tags = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * @memberof types.MessageCreateQuestion
         * @instance
         */
        MessageCreateQuestion.prototype.authorAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageCreateQuestion.prototype.title = "";
         ...
         * @instance
         */
        MessageCreateQuestion.prototype.contentHash = "";
         ...
         * @instance
         */
        MessageCreateQuestion.prototype.category = "";
         ...
         * @instance
         */
        MessageCreateQuestion.prototype.tags = $util.emptyArray;
         ...
         * @static
         * @param {types.IMessageCreateQuestion=} [properties] Properties to set
         * @returns {types.MessageCreateQuestion} MessageCreateQuestion instance
         */
        MessageCreateQuestion.create = function create(properties) {
            return new MessageCreateQuestion(properties);
        };
         ...
         * @memberof types.MessageCreateQuestion
         * @static
         * @param {types.IMessageCreateQuestion} message MessageCreateQuestion message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageCreateQuestion.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageCreateQuestion.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageCreateQuestion} MessageCreateQuestion
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageCreateQuestion.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageCreateQuestion();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageCreateQuestion.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageCreateQuestion.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
         ...
         * @returns {types.MessageCreateQuestion} MessageCreateQuestion
         */
        MessageCreateQuestion.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageCreateQuestion)
                return object;
            var message = new $root.types.MessageCreateQuestion();
            ...
            if (object.tags) {
                if (!Array.isArray(object.tags))
                    throw TypeError(".types.MessageCreateQuestion.tags: array expected");
                message.tags = [];
         ...
         * @memberof types.MessageCreateQuestion
         * @static
         * @param {types.MessageCreateQuestion} message MessageCreateQuestion
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageCreateQuestion.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageCreateQuestion.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageCreateQuestion.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageCreateQuestion";
        };

        return MessageCreateQuestion;
    })();

    types.MessageSubmitAnswer = (function() {

        /**
         * Properties of a MessageSubmitAnswer.
         * @memberof types
         * @interface IMessageSubmitAnswer
         * @property {Uint8Array|null} [authorAddress] MessageSubmitAnswer authorAddress
         * @property {string|null} [questionId] MessageSubmitAnswer questionId
         * @property {string|null} [contentHash] MessageSubmitAnswer contentHash
         * @property {number|Long|null} [stakeAmount] MessageSubmitAnswer stakeAmount
         */

        /**
         * Constructs a new MessageSubmitAnswer.
         * @memberof types
         * @classdesc Represents a MessageSubmitAnswer.
         * @implements IMessageSubmitAnswer
         * @constructor
         * @param {types.IMessageSubmitAnswer=} [properties] Properties to set
         */
        function MessageSubmitAnswer(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {Uint8Array} authorAddress
         * @memberof types.MessageSubmitAnswer
         * @instance
         */
        MessageSubmitAnswer.prototype.authorAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageSubmitAnswer.prototype.questionId = "";
         ...
         * @instance
         */
        MessageSubmitAnswer.prototype.contentHash = "";
         ...
         * @instance
         */
        MessageSubmitAnswer.prototype.stakeAmount = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @static
         * @param {types.IMessageSubmitAnswer=} [properties] Properties to set
         * @returns {types.MessageSubmitAnswer} MessageSubmitAnswer instance
         */
        MessageSubmitAnswer.create = function create(properties) {
            return new MessageSubmitAnswer(properties);
        };
         ...
         * @memberof types.MessageSubmitAnswer
         * @static
         * @param {types.IMessageSubmitAnswer} message MessageSubmitAnswer message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageSubmitAnswer.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.authorAddress != null && Object.hasOwnProperty.call(message, "authorAddress"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.authorAddress);
            ...
            if (message.stakeAmount != null && Object.hasOwnProperty.call(message, "stakeAmount"))
                writer.uint32(/* id 4, wireType 0 =*/32).uint64(message.stakeAmount);
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageSubmitAnswer.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageSubmitAnswer} MessageSubmitAnswer
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageSubmitAnswer.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageSubmitAnswer();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageSubmitAnswer.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageSubmitAnswer.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.authorAddress != null && message.hasOwnProperty("authorAddress"))
                if (!(message.authorAddress && typeof message.authorAddress.length === "number" || $util.isString(message.authorAddress)))
         ...
         * @returns {types.MessageSubmitAnswer} MessageSubmitAnswer
         */
        MessageSubmitAnswer.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageSubmitAnswer)
                return object;
            var message = new $root.types.MessageSubmitAnswer();
            if (object.authorAddress != null)
                if (typeof object.authorAddress === "string")
                    $util.base64.decode(object.authorAddress, message.authorAddress = $util.newBuffer($util.base64.length(object.authorAddress)), 0);
                else if (object.authorAddress.length >= 0)
         ...
         * @memberof types.MessageSubmitAnswer
         * @static
         * @param {types.MessageSubmitAnswer} message MessageSubmitAnswer
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageSubmitAnswer.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageSubmitAnswer.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageSubmitAnswer.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageSubmitAnswer";
        };

        return MessageSubmitAnswer;
    })();

    types.MessageAcceptAnswer = (function() {

        /**
         * Properties of a MessageAcceptAnswer.
         * @memberof types
         * @interface IMessageAcceptAnswer
         * @property {Uint8Array|null} [ownerAddress] MessageAcceptAnswer ownerAddress
         * @property {string|null} [questionId] MessageAcceptAnswer questionId
         * @property {string|null} [answerId] MessageAcceptAnswer answerId
         */

        /**
         * Constructs a new MessageAcceptAnswer.
         * @memberof types
         * @classdesc Represents a MessageAcceptAnswer.
         * @implements IMessageAcceptAnswer
         * @constructor
         * @param {types.IMessageAcceptAnswer=} [properties] Properties to set
         */
        function MessageAcceptAnswer(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @memberof types.MessageAcceptAnswer
         * @instance
         */
        MessageAcceptAnswer.prototype.ownerAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageAcceptAnswer.prototype.questionId = "";
         ...
         * @instance
         */
        MessageAcceptAnswer.prototype.answerId = "";
         ...
         * @static
         * @param {types.IMessageAcceptAnswer=} [properties] Properties to set
         * @returns {types.MessageAcceptAnswer} MessageAcceptAnswer instance
         */
        MessageAcceptAnswer.create = function create(properties) {
            return new MessageAcceptAnswer(properties);
        };
         ...
         * @memberof types.MessageAcceptAnswer
         * @static
         * @param {types.IMessageAcceptAnswer} message MessageAcceptAnswer message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageAcceptAnswer.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.answerId != null && Object.hasOwnProperty.call(message, "answerId"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.answerId);
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageAcceptAnswer.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageAcceptAnswer} MessageAcceptAnswer
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageAcceptAnswer.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageAcceptAnswer();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageAcceptAnswer.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageAcceptAnswer.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
         ...
         * @returns {types.MessageAcceptAnswer} MessageAcceptAnswer
         */
        MessageAcceptAnswer.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageAcceptAnswer)
                return object;
            var message = new $root.types.MessageAcceptAnswer();
         ...
         * @memberof types.MessageAcceptAnswer
         * @static
         * @param {types.MessageAcceptAnswer} message MessageAcceptAnswer
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageAcceptAnswer.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageAcceptAnswer.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageAcceptAnswer.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageAcceptAnswer";
        };

        return MessageAcceptAnswer;
    })();

    types.MessageDisputeAnswer = (function() {

        /**
         * Properties of a MessageDisputeAnswer.
         * @memberof types
         * @interface IMessageDisputeAnswer
         * @property {Uint8Array|null} [disputerAddress] MessageDisputeAnswer disputerAddress
         * @property {string|null} [answerId] MessageDisputeAnswer answerId
         * @property {string|null} [reasonHash] MessageDisputeAnswer reasonHash
         */

        /**
         * Constructs a new MessageDisputeAnswer.
         * @memberof types
         * @classdesc Represents a MessageDisputeAnswer.
         * @implements IMessageDisputeAnswer
         * @constructor
         * @param {types.IMessageDisputeAnswer=} [properties] Properties to set
         */
        function MessageDisputeAnswer(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {Uint8Array} disputerAddress
         * @memberof types.MessageDisputeAnswer
         * @instance
         */
        MessageDisputeAnswer.prototype.disputerAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageDisputeAnswer.prototype.answerId = "";

        /**
         * MessageDisputeAnswer reasonHash.
         * @member {string} reasonHash
         * @memberof types.MessageDisputeAnswer
         * @instance
         */
        MessageDisputeAnswer.prototype.reasonHash = "";
         ...
         * @static
         * @param {types.IMessageDisputeAnswer=} [properties] Properties to set
         * @returns {types.MessageDisputeAnswer} MessageDisputeAnswer instance
         */
        MessageDisputeAnswer.create = function create(properties) {
            return new MessageDisputeAnswer(properties);
        };
         ...
         * @memberof types.MessageDisputeAnswer
         * @static
         * @param {types.IMessageDisputeAnswer} message MessageDisputeAnswer message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageDisputeAnswer.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.disputerAddress != null && Object.hasOwnProperty.call(message, "disputerAddress"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.disputerAddress);
            if (message.answerId != null && Object.hasOwnProperty.call(message, "answerId"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.answerId);
            if (message.reasonHash != null && Object.hasOwnProperty.call(message, "reasonHash"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.reasonHash);
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageDisputeAnswer.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageDisputeAnswer} MessageDisputeAnswer
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageDisputeAnswer.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageDisputeAnswer();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.disputerAddress = reader.bytes();
                        break;
                    }
                case 2: {
                        message.answerId = reader.string();
                ...
                case 3: {
                        message.reasonHash = reader.string();
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageDisputeAnswer.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageDisputeAnswer.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.disputerAddress != null && message.hasOwnProperty("disputerAddress"))
                if (!(message.disputerAddress && typeof message.disputerAddress.length === "number" || $util.isString(message.disputerAddress)))
                    return "disputerAddress: buffer expected";
            if (message.answerId != null && message.hasOwnProperty("answerId"))
                if (!$util.isString(message.answerId))
                    return "answerId: string expected";
            if (message.reasonHash != null && message.hasOwnProperty("reasonHash"))
                if (!$util.isString(message.reasonHash))
                    return "reasonHash: string expected";
            return null;
        };
         ...
         * @returns {types.MessageDisputeAnswer} MessageDisputeAnswer
         */
        MessageDisputeAnswer.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageDisputeAnswer)
                return object;
            var message = new $root.types.MessageDisputeAnswer();
            if (object.disputerAddress != null)
                if (typeof object.disputerAddress === "string")
                    $util.base64.decode(object.disputerAddress, message.disputerAddress = $util.newBuffer($util.base64.length(object.disputerAddress)), 0);
                else if (object.disputerAddress.length >= 0)
                    message.disputerAddress = object.disputerAddress;
            if (object.answerId != null)
                message.answerId = String(object.answerId);
            if (object.reasonHash != null)
                message.reasonHash = String(object.reasonHash);
            return message;
        };
         ...
         * @memberof types.MessageDisputeAnswer
         * @static
         * @param {types.MessageDisputeAnswer} message MessageDisputeAnswer
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageDisputeAnswer.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                if (options.bytes === String)
                    object.disputerAddress = "";
                else {
                    object.disputerAddress = [];
                    if (options.bytes !== Array)
                        object.disputerAddress = $util.newBuffer(object.disputerAddress);
                }
                object.answerId = "";
                object.reasonHash = "";
            }
            if (message.disputerAddress != null && message.hasOwnProperty("disputerAddress"))
                object.disputerAddress = options.bytes === String ? $util.base64.encode(message.disputerAddress, 0, message.disputerAddress.length) : options.bytes === Array ? Array.prototype.slice.call(message.disputerAddress) : message.disputerAddress;
            if (message.answerId != null && message.hasOwnProperty("answerId"))
                object.answerId = message.answerId;
            if (message.reasonHash != null && message.hasOwnProperty("reasonHash"))
                object.reasonHash = message.reasonHash;
            return object;
        };
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageDisputeAnswer.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageDisputeAnswer.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageDisputeAnswer";
        };

        return MessageDisputeAnswer;
    })();

    types.MessageVerifyAnswer = (function() {

        /**
         * Properties of a MessageVerifyAnswer.
         * @memberof types
         * @interface IMessageVerifyAnswer
         * @property {Uint8Array|null} [voterAddress] MessageVerifyAnswer voterAddress
         * @property {string|null} [answerId] MessageVerifyAnswer answerId
         * @property {string|null} [vote] MessageVerifyAnswer vote
         */

        /**
         * Constructs a new MessageVerifyAnswer.
         * @memberof types
         * @classdesc Represents a MessageVerifyAnswer.
         * @implements IMessageVerifyAnswer
         * @constructor
         * @param {types.IMessageVerifyAnswer=} [properties] Properties to set
         */
        function MessageVerifyAnswer(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @memberof types.MessageVerifyAnswer
         * @instance
         */
        MessageVerifyAnswer.prototype.voterAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageVerifyAnswer.prototype.answerId = "";
         ...
         * @instance
         */
        MessageVerifyAnswer.prototype.vote = "";
         ...
         * @static
         * @param {types.IMessageVerifyAnswer=} [properties] Properties to set
         * @returns {types.MessageVerifyAnswer} MessageVerifyAnswer instance
         */
        MessageVerifyAnswer.create = function create(properties) {
            return new MessageVerifyAnswer(properties);
        };
         ...
         * @memberof types.MessageVerifyAnswer
         * @static
         * @param {types.IMessageVerifyAnswer} message MessageVerifyAnswer message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageVerifyAnswer.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.vote != null && Object.hasOwnProperty.call(message, "vote"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.vote);
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageVerifyAnswer.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageVerifyAnswer} MessageVerifyAnswer
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageVerifyAnswer.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageVerifyAnswer();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageVerifyAnswer.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageVerifyAnswer.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
         ...
         * @returns {types.MessageVerifyAnswer} MessageVerifyAnswer
         */
        MessageVerifyAnswer.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageVerifyAnswer)
                return object;
            var message = new $root.types.MessageVerifyAnswer();
         ...
         * @memberof types.MessageVerifyAnswer
         * @static
         * @param {types.MessageVerifyAnswer} message MessageVerifyAnswer
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageVerifyAnswer.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageVerifyAnswer.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageVerifyAnswer.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageVerifyAnswer";
        };

        return MessageVerifyAnswer;
    })();

    types.MessageStakeReputation = (function() {

        /**
         * Properties of a MessageStakeReputation.
         * @memberof types
         * @interface IMessageStakeReputation
         * @property {Uint8Array|null} [address] MessageStakeReputation address
         * @property {string|null} [answerId] MessageStakeReputation answerId
         * @property {number|Long|null} [stakeAmount] MessageStakeReputation stakeAmount
         */

        /**
         * Constructs a new MessageStakeReputation.
         * @memberof types
         * @classdesc Represents a MessageStakeReputation.
         * @implements IMessageStakeReputation
         * @constructor
         * @param {types.IMessageStakeReputation=} [properties] Properties to set
         */
        function MessageStakeReputation(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {Uint8Array} address
         * @memberof types.MessageStakeReputation
         * @instance
         */
        MessageStakeReputation.prototype.address = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageStakeReputation.prototype.answerId = "";
         ...
         * @instance
         */
        MessageStakeReputation.prototype.stakeAmount = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @static
         * @param {types.IMessageStakeReputation=} [properties] Properties to set
         * @returns {types.MessageStakeReputation} MessageStakeReputation instance
         */
        MessageStakeReputation.create = function create(properties) {
            return new MessageStakeReputation(properties);
        };
         ...
         * @memberof types.MessageStakeReputation
         * @static
         * @param {types.IMessageStakeReputation} message MessageStakeReputation message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageStakeReputation.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.address != null && Object.hasOwnProperty.call(message, "address"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.address);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageStakeReputation.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageStakeReputation} MessageStakeReputation
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageStakeReputation.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageStakeReputation();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageStakeReputation.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageStakeReputation.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.address != null && message.hasOwnProperty("address"))
                if (!(message.address && typeof message.address.length === "number" || $util.isString(message.address)))
         ...
         * @returns {types.MessageStakeReputation} MessageStakeReputation
         */
        MessageStakeReputation.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageStakeReputation)
                return object;
            var message = new $root.types.MessageStakeReputation();
            if (object.address != null)
                if (typeof object.address === "string")
                    $util.base64.decode(object.address, message.address = $util.newBuffer($util.base64.length(object.address)), 0);
                else if (object.address.length >= 0)
         ...
         * @memberof types.MessageStakeReputation
         * @static
         * @param {types.MessageStakeReputation} message MessageStakeReputation
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageStakeReputation.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageStakeReputation.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageStakeReputation.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageStakeReputation";
        };

        return MessageStakeReputation;
    })();

    types.MessageRewardReputation = (function() {

        /**
         * Properties of a MessageRewardReputation.
         * @memberof types
         * @interface IMessageRewardReputation
         * @property {Uint8Array|null} [fromAddress] MessageRewardReputation fromAddress
         * @property {Uint8Array|null} [toAddress] MessageRewardReputation toAddress
         * @property {number|Long|null} [points] MessageRewardReputation points
         * @property {string|null} [reason] MessageRewardReputation reason
         */

        /**
         * Constructs a new MessageRewardReputation.
         * @memberof types
         * @classdesc Represents a MessageRewardReputation.
         * @implements IMessageRewardReputation
         * @constructor
         * @param {types.IMessageRewardReputation=} [properties] Properties to set
         */
        function MessageRewardReputation(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {Uint8Array} fromAddress
         * @memberof types.MessageRewardReputation
         * @instance
         */
        MessageRewardReputation.prototype.fromAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageRewardReputation.prototype.toAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageRewardReputation.prototype.points = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        MessageRewardReputation.prototype.reason = "";
         ...
         * @static
         * @param {types.IMessageRewardReputation=} [properties] Properties to set
         * @returns {types.MessageRewardReputation} MessageRewardReputation instance
         */
        MessageRewardReputation.create = function create(properties) {
            return new MessageRewardReputation(properties);
        };
         ...
         * @memberof types.MessageRewardReputation
         * @static
         * @param {types.IMessageRewardReputation} message MessageRewardReputation message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageRewardReputation.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.fromAddress != null && Object.hasOwnProperty.call(message, "fromAddress"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.fromAddress);
            ...
            if (message.points != null && Object.hasOwnProperty.call(message, "points"))
                writer.uint32(/* id 3, wireType 0 =*/24).uint64(message.points);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageRewardReputation.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageRewardReputation} MessageRewardReputation
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageRewardReputation.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageRewardReputation();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageRewardReputation.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageRewardReputation.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.fromAddress != null && message.hasOwnProperty("fromAddress"))
                if (!(message.fromAddress && typeof message.fromAddress.length === "number" || $util.isString(message.fromAddress)))
         ...
         * @returns {types.MessageRewardReputation} MessageRewardReputation
         */
        MessageRewardReputation.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageRewardReputation)
                return object;
            var message = new $root.types.MessageRewardReputation();
            if (object.fromAddress != null)
                if (typeof object.fromAddress === "string")
                    $util.base64.decode(object.fromAddress, message.fromAddress = $util.newBuffer($util.base64.length(object.fromAddress)), 0);
                else if (object.fromAddress.length >= 0)
         ...
         * @memberof types.MessageRewardReputation
         * @static
         * @param {types.MessageRewardReputation} message MessageRewardReputation
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageRewardReputation.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageRewardReputation.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageRewardReputation.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageRewardReputation";
        };

        return MessageRewardReputation;
    })();

    types.MessagePenaltyReputation = (function() {

        /**
         * Properties of a MessagePenaltyReputation.
         * @memberof types
         * @interface IMessagePenaltyReputation
         * @property {Uint8Array|null} [fromAddress] MessagePenaltyReputation fromAddress
         * @property {Uint8Array|null} [toAddress] MessagePenaltyReputation toAddress
         * @property {number|Long|null} [points] MessagePenaltyReputation points
         * @property {string|null} [reason] MessagePenaltyReputation reason
         */

        /**
         * Constructs a new MessagePenaltyReputation.
         * @memberof types
         * @classdesc Represents a MessagePenaltyReputation.
         * @implements IMessagePenaltyReputation
         * @constructor
         * @param {types.IMessagePenaltyReputation=} [properties] Properties to set
         */
        function MessagePenaltyReputation(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {Uint8Array} fromAddress
         * @memberof types.MessagePenaltyReputation
         * @instance
         */
        MessagePenaltyReputation.prototype.fromAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessagePenaltyReputation.prototype.toAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessagePenaltyReputation.prototype.points = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        MessagePenaltyReputation.prototype.reason = "";
         ...
         * @static
         * @param {types.IMessagePenaltyReputation=} [properties] Properties to set
         * @returns {types.MessagePenaltyReputation} MessagePenaltyReputation instance
         */
        MessagePenaltyReputation.create = function create(properties) {
            return new MessagePenaltyReputation(properties);
        };
         ...
         * @memberof types.MessagePenaltyReputation
         * @static
         * @param {types.IMessagePenaltyReputation} message MessagePenaltyReputation message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessagePenaltyReputation.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.fromAddress != null && Object.hasOwnProperty.call(message, "fromAddress"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.fromAddress);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessagePenaltyReputation.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessagePenaltyReputation} MessagePenaltyReputation
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessagePenaltyReputation.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessagePenaltyReputation();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessagePenaltyReputation.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessagePenaltyReputation.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.fromAddress != null && message.hasOwnProperty("fromAddress"))
                if (!(message.fromAddress && typeof message.fromAddress.length === "number" || $util.isString(message.fromAddress)))
         ...
         * @returns {types.MessagePenaltyReputation} MessagePenaltyReputation
         */
        MessagePenaltyReputation.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessagePenaltyReputation)
                return object;
            var message = new $root.types.MessagePenaltyReputation();
            if (object.fromAddress != null)
                if (typeof object.fromAddress === "string")
                    $util.base64.decode(object.fromAddress, message.fromAddress = $util.newBuffer($util.base64.length(object.fromAddress)), 0);
                else if (object.fromAddress.length >= 0)
         ...
         * @memberof types.MessagePenaltyReputation
         * @static
         * @param {types.MessagePenaltyReputation} message MessagePenaltyReputation
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessagePenaltyReputation.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessagePenaltyReputation.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessagePenaltyReputation.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessagePenaltyReputation";
        };

        return MessagePenaltyReputation;
    })();

    types.MessageFollowUser = (function() {

        /**
         * Properties of a MessageFollowUser.
         * @memberof types
         * @interface IMessageFollowUser
         * @property {Uint8Array|null} [followerAddress] MessageFollowUser followerAddress
         * @property {Uint8Array|null} [targetAddress] MessageFollowUser targetAddress
         */

        /**
         * Constructs a new MessageFollowUser.
         * @memberof types
         * @classdesc Represents a MessageFollowUser.
         * @implements IMessageFollowUser
         * @constructor
         * @param {types.IMessageFollowUser=} [properties] Properties to set
         */
        function MessageFollowUser(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {Uint8Array} followerAddress
         * @memberof types.MessageFollowUser
         * @instance
         */
        MessageFollowUser.prototype.followerAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageFollowUser.prototype.targetAddress = $util.newBuffer([]);
         ...
         * @static
         * @param {types.IMessageFollowUser=} [properties] Properties to set
         * @returns {types.MessageFollowUser} MessageFollowUser instance
         */
        MessageFollowUser.create = function create(properties) {
            return new MessageFollowUser(properties);
        };
         ...
         * @memberof types.MessageFollowUser
         * @static
         * @param {types.IMessageFollowUser} message MessageFollowUser message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageFollowUser.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.followerAddress != null && Object.hasOwnProperty.call(message, "followerAddress"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.followerAddress);
            if (message.targetAddress != null && Object.hasOwnProperty.call(message, "targetAddress"))
                writer.uint32(/* id 2, wireType 2 =*/18).bytes(message.targetAddress);
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageFollowUser.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageFollowUser} MessageFollowUser
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageFollowUser.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageFollowUser();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.followerAddress = reader.bytes();
                        break;
                    }
                case 2: {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageFollowUser.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageFollowUser.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.followerAddress != null && message.hasOwnProperty("followerAddress"))
                if (!(message.followerAddress && typeof message.followerAddress.length === "number" || $util.isString(message.followerAddress)))
                    return "followerAddress: buffer expected";
         ...
         * @returns {types.MessageFollowUser} MessageFollowUser
         */
        MessageFollowUser.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageFollowUser)
                return object;
            var message = new $root.types.MessageFollowUser();
            if (object.followerAddress != null)
                if (typeof object.followerAddress === "string")
                    $util.base64.decode(object.followerAddress, message.followerAddress = $util.newBuffer($util.base64.length(object.followerAddress)), 0);
                else if (object.followerAddress.length >= 0)
                    message.followerAddress = object.followerAddress;
         ...
         * @memberof types.MessageFollowUser
         * @static
         * @param {types.MessageFollowUser} message MessageFollowUser
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageFollowUser.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                if (options.bytes === String)
                    object.followerAddress = "";
                else {
                    object.followerAddress = [];
                    if (options.bytes !== Array)
                        object.followerAddress = $util.newBuffer(object.followerAddress);
                }
                if (options.bytes === String)
            ...
            if (message.followerAddress != null && message.hasOwnProperty("followerAddress"))
                object.followerAddress = options.bytes === String ? $util.base64.encode(message.followerAddress, 0, message.followerAddress.length) : options.bytes === Array ? Array.prototype.slice.call(message.followerAddress) : message.followerAddress;
            if (message.targetAddress != null && message.hasOwnProperty("targetAddress"))
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageFollowUser.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageFollowUser.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageFollowUser";
        };

        return MessageFollowUser;
    })();

    types.MessageEndorseMember = (function() {

        /**
         * Properties of a MessageEndorseMember.
         * @memberof types
         * @interface IMessageEndorseMember
         * @property {Uint8Array|null} [endorserAddress] MessageEndorseMember endorserAddress
         * @property {Uint8Array|null} [targetAddress] MessageEndorseMember targetAddress
         * @property {string|null} [skill] MessageEndorseMember skill
         */

        /**
         * Constructs a new MessageEndorseMember.
         * @memberof types
         * @classdesc Represents a MessageEndorseMember.
         * @implements IMessageEndorseMember
         * @constructor
         * @param {types.IMessageEndorseMember=} [properties] Properties to set
         */
        function MessageEndorseMember(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {Uint8Array} endorserAddress
         * @memberof types.MessageEndorseMember
         * @instance
         */
        MessageEndorseMember.prototype.endorserAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageEndorseMember.prototype.targetAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageEndorseMember.prototype.skill = "";
         ...
         * @static
         * @param {types.IMessageEndorseMember=} [properties] Properties to set
         * @returns {types.MessageEndorseMember} MessageEndorseMember instance
         */
        MessageEndorseMember.create = function create(properties) {
            return new MessageEndorseMember(properties);
        };
         ...
         * @memberof types.MessageEndorseMember
         * @static
         * @param {types.IMessageEndorseMember} message MessageEndorseMember message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageEndorseMember.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.endorserAddress != null && Object.hasOwnProperty.call(message, "endorserAddress"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.endorserAddress);
            if (message.targetAddress != null && Object.hasOwnProperty.call(message, "targetAddress"))
                writer.uint32(/* id 2, wireType 2 =*/18).bytes(message.targetAddress);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageEndorseMember.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageEndorseMember} MessageEndorseMember
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageEndorseMember.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageEndorseMember();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.endorserAddress = reader.bytes();
                        break;
                    }
                case 2: {
                        message.targetAddress = reader.bytes();
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageEndorseMember.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageEndorseMember.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.endorserAddress != null && message.hasOwnProperty("endorserAddress"))
                if (!(message.endorserAddress && typeof message.endorserAddress.length === "number" || $util.isString(message.endorserAddress)))
                    return "endorserAddress: buffer expected";
            if (message.targetAddress != null && message.hasOwnProperty("targetAddress"))
                if (!(message.targetAddress && typeof message.targetAddress.length === "number" || $util.isString(message.targetAddress)))
                    return "targetAddress: buffer expected";
         ...
         * @returns {types.MessageEndorseMember} MessageEndorseMember
         */
        MessageEndorseMember.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageEndorseMember)
                return object;
            var message = new $root.types.MessageEndorseMember();
            if (object.endorserAddress != null)
                if (typeof object.endorserAddress === "string")
                    $util.base64.decode(object.endorserAddress, message.endorserAddress = $util.newBuffer($util.base64.length(object.endorserAddress)), 0);
                else if (object.endorserAddress.length >= 0)
                    message.endorserAddress = object.endorserAddress;
            if (object.targetAddress != null)
                if (typeof object.targetAddress === "string")
                    $util.base64.decode(object.targetAddress, message.targetAddress = $util.newBuffer($util.base64.length(object.targetAddress)), 0);
                else if (object.targetAddress.length >= 0)
         ...
         * @memberof types.MessageEndorseMember
         * @static
         * @param {types.MessageEndorseMember} message MessageEndorseMember
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageEndorseMember.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                if (options.bytes === String)
                    object.endorserAddress = "";
                else {
                    object.endorserAddress = [];
                    if (options.bytes !== Array)
                        object.endorserAddress = $util.newBuffer(object.endorserAddress);
                }
                if (options.bytes === String)
                    object.targetAddress = "";
                else {
            ...
            if (message.endorserAddress != null && message.hasOwnProperty("endorserAddress"))
                object.endorserAddress = options.bytes === String ? $util.base64.encode(message.endorserAddress, 0, message.endorserAddress.length) : options.bytes === Array ? Array.prototype.slice.call(message.endorserAddress) : message.endorserAddress;
            if (message.targetAddress != null && message.hasOwnProperty("targetAddress"))
                object.targetAddress = options.bytes === String ? $util.base64.encode(message.targetAddress, 0, message.targetAddress.length) : options.bytes === Array ? Array.prototype.slice.call(message.targetAddress) : message.targetAddress;
            if (message.skill != null && message.hasOwnProperty("skill"))
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageEndorseMember.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageEndorseMember.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageEndorseMember";
        };

        return MessageEndorseMember;
    })();

    types.MessageCreateTribe = (function() {

        /**
         * Properties of a MessageCreateTribe.
         * @memberof types
         * @interface IMessageCreateTribe
         * @property {Uint8Array|null} [creatorAddress] MessageCreateTribe creatorAddress
         * @property {string|null} [name] MessageCreateTribe name
         * @property {string|null} [description] MessageCreateTribe description
         * @property {string|null} [category] MessageCreateTribe category
         */

        /**
         * Constructs a new MessageCreateTribe.
         * @memberof types
         * @classdesc Represents a MessageCreateTribe.
         * @implements IMessageCreateTribe
         * @constructor
         * @param {types.IMessageCreateTribe=} [properties] Properties to set
         */
        function MessageCreateTribe(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @memberof types.MessageCreateTribe
         * @instance
         */
        MessageCreateTribe.prototype.creatorAddress = $util.newBuffer([]);
         ...
         * @instance
         */
        MessageCreateTribe.prototype.name = "";
         ...
         * @instance
         */
        MessageCreateTribe.prototype.description = "";
         ...
         * @instance
         */
        MessageCreateTribe.prototype.category = "";
         ...
         * @static
         * @param {types.IMessageCreateTribe=} [properties] Properties to set
         * @returns {types.MessageCreateTribe} MessageCreateTribe instance
         */
        MessageCreateTribe.create = function create(properties) {
            return new MessageCreateTribe(properties);
        };
         ...
         * @memberof types.MessageCreateTribe
         * @static
         * @param {types.IMessageCreateTribe} message MessageCreateTribe message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageCreateTribe.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageCreateTribe.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageCreateTribe} MessageCreateTribe
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageCreateTribe.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageCreateTribe();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageCreateTribe.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageCreateTribe.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
         ...
         * @returns {types.MessageCreateTribe} MessageCreateTribe
         */
        MessageCreateTribe.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageCreateTribe)
                return object;
            var message = new $root.types.MessageCreateTribe();
         ...
         * @memberof types.MessageCreateTribe
         * @static
         * @param {types.MessageCreateTribe} message MessageCreateTribe
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageCreateTribe.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageCreateTribe.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageCreateTribe.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageCreateTribe";
        };

        return MessageCreateTribe;
    })();

    types.MessageJoinTribe = (function() {

        /**
         * Properties of a MessageJoinTribe.
         * @memberof types
         * @interface IMessageJoinTribe
         * @property {Uint8Array|null} [memberAddress] MessageJoinTribe memberAddress
         * @property {string|null} [tribeId] MessageJoinTribe tribeId
         */

        /**
         * Constructs a new MessageJoinTribe.
         * @memberof types
         * @classdesc Represents a MessageJoinTribe.
         * @implements IMessageJoinTribe
         * @constructor
         * @param {types.IMessageJoinTribe=} [properties] Properties to set
         */
        function MessageJoinTribe(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @memberof types.MessageJoinTribe
         * @instance
         */
        MessageJoinTribe.prototype.memberAddress = $util.newBuffer([]);

        /**
         * MessageJoinTribe tribeId.
         * @member {string} tribeId
         * @memberof types.MessageJoinTribe
         * @instance
         */
        MessageJoinTribe.prototype.tribeId = "";
         ...
         * @static
         * @param {types.IMessageJoinTribe=} [properties] Properties to set
         * @returns {types.MessageJoinTribe} MessageJoinTribe instance
         */
        MessageJoinTribe.create = function create(properties) {
            return new MessageJoinTribe(properties);
        };
         ...
         * @memberof types.MessageJoinTribe
         * @static
         * @param {types.IMessageJoinTribe} message MessageJoinTribe message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MessageJoinTribe.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.tribeId != null && Object.hasOwnProperty.call(message, "tribeId"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.tribeId);
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MessageJoinTribe.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {types.MessageJoinTribe} MessageJoinTribe
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageJoinTribe.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.types.MessageJoinTribe();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MessageJoinTribe.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MessageJoinTribe.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            ...
            if (message.tribeId != null && message.hasOwnProperty("tribeId"))
                if (!$util.isString(message.tribeId))
                    return "tribeId: string expected";
            return null;
        };
         ...
         * @returns {types.MessageJoinTribe} MessageJoinTribe
         */
        MessageJoinTribe.fromObject = function fromObject(object) {
            if (object instanceof $root.types.MessageJoinTribe)
                return object;
            var message = new $root.types.MessageJoinTribe();
            ...
            if (object.tribeId != null)
                message.tribeId = String(object.tribeId);
            return message;
        };
         ...
         * @memberof types.MessageJoinTribe
         * @static
         * @param {types.MessageJoinTribe} message MessageJoinTribe
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MessageJoinTribe.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
            ...
            if (message.tribeId != null && message.hasOwnProperty("tribeId"))
                object.tribeId = message.tribeId;
            return object;
        };
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MessageJoinTribe.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MessageJoinTribe.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/types.MessageJoinTribe";
        };

        return MessageJoinTribe;
    })();
