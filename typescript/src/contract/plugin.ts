...
export function FromAny(any: any): [any | null, string | null, IPluginError | null] {
    ...
    try {
        ...
        if (typeUrl.includes('MessageCreateQuestion')) { return [types.MessageCreateQuestion.decode(any.value), 'MessageCreateQuestion', null]; }
        if (typeUrl.includes('MessageSubmitAnswer')) { return [types.MessageSubmitAnswer.decode(any.value), 'MessageSubmitAnswer', null]; }
        if (typeUrl.includes('MessageAcceptAnswer')) { return [types.MessageAcceptAnswer.decode(any.value), 'MessageAcceptAnswer', null]; }
        if (typeUrl.includes('MessageDisputeAnswer')) { return [types.MessageDisputeAnswer.decode(any.value), 'MessageDisputeAnswer', null]; }
        if (typeUrl.includes('MessageVerifyAnswer')) { return [types.MessageVerifyAnswer.decode(any.value), 'MessageVerifyAnswer', null]; }
        if (typeUrl.includes('MessageStakeReputation')) { return [types.MessageStakeReputation.decode(any.value), 'MessageStakeReputation', null]; }
        if (typeUrl.includes('MessageRewardReputation')) { return [types.MessageRewardReputation.decode(any.value), 'MessageRewardReputation', null]; }
        if (typeUrl.includes('MessagePenaltyReputation')) { return [types.MessagePenaltyReputation.decode(any.value), 'MessagePenaltyReputation', null]; }
        if (typeUrl.includes('MessageFollowUser')) { return [types.MessageFollowUser.decode(any.value), 'MessageFollowUser', null]; }
        if (typeUrl.includes('MessageEndorseMember')) { return [types.MessageEndorseMember.decode(any.value), 'MessageEndorseMember', null]; }
        if (typeUrl.includes('MessageCreateTribe')) { return [types.MessageCreateTribe.decode(any.value), 'MessageCreateTribe', null]; }
        if (typeUrl.includes('MessageJoinTribe')) { return [types.MessageJoinTribe.decode(any.value), 'MessageJoinTribe', null]; }
